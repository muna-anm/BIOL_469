...
cax = ax.imshow(values, cmap='viridis', aspect='auto')  # You can choose other colormaps like 'hot', 'cool', 'plasma', etc.
...
# Set all the titles and x/y axis labels
#fig.subplots_adjust(top=0.9)
#ax.set_xlabel('Genes Associated with Pathogenicity')
#ax.set_ylabel('14 Erwinia Genomes')
#ax.set_title('Analyzing Pathogen-Associated Gene Counts')
